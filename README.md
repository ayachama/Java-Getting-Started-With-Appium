# Java-Getting-Started-With-Appium

These scripts are examples of how to use Appium in Java specifically fore the "Getting Started with Appium" elearning tutorials.
